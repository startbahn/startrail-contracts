...
import "../common/IStartrailRegistryV24.sol";
...
contract StartrailRegistryV24 is
    Contracts,
    ...
    IERC2981
{
    ...
    /**
     * @dev Creates a registryRecord of an artwork from LicensedUser wallet and transfers it to the recipient (deprecated form)
    ...
    ) public override(IStartrailRegistryV24) trustedForwarderOnly {
    ...
    // backward compatibility (deprecated form)
    function createSRRFromBulk(
        ...
        address royaltyReceiver,
        uint16 royaltyBasisPoints
    ) public override(IStartrailRegistryV24) returns (uint256) {
        onlyBulk();
        return
            _createSRR(
                isPrimaryIssuer,
    ...
    ) public override(IStartrailRegistryV24) {
        onlyBulk();
    ...
    function transferFromWithProvenanceFromBulk(
        ...
        uint256 customHistoryId,
        bool isIntermediary
    ) external override(IStartrailRegistryV24) {
        onlyBulk();
        onlySRROwner(signer, tokenId);
    ...
    function getSRR(
        ...
        public
        view
        override(IStartrailRegistryV24)
        returns (
    ...
    ) public view override(IStartrailRegistryV24) returns (string memory) {
    ...
    function lockExternalTransfer(
        uint256 tokenId
    ) public view override(IStartrailRegistryV24) returns (bool) {
