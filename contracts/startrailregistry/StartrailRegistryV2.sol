...
import "../common/IStartrailRegistryV2.sol";
...
contract StartrailRegistryV2 is
    Contracts,
    IERC2477,
    ...
    EIP2771BaseRecipient
{
    ...
    ) public override(IStartrailRegistryV2) onlyBulk returns (uint256) {
        return
            _createSRR(
                isPrimaryIssuer,
                artistAddress,
    ...
    ) public override(IStartrailRegistryV2) onlyBulkTransfer {
    ...
    function transferSRRByReveal(
        ...
        bytes32 reveal,
        uint256 tokenId
    ) public override(IStartrailRegistryV2) tokenExists(tokenId) {
        bytes32 commitment;
