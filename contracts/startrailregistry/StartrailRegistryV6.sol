...
import "../common/IStartrailRegistryV6.sol";
...
contract StartrailRegistryV6 is
    Contracts,
    IERC2477,
    ...
    EIP2771BaseRecipient
{
    ...
    function createSRRFromBulk(
        ...
        bool lockExternalTransfer
    ) public override(IStartrailRegistryV6) onlyBulkIssue returns (uint256) {
        return 
            _createSRR(
                isPrimaryIssuer,
                artistAddress,
    ...
    ) public override(IStartrailRegistryV6) onlyBulkTransfer {
    ...
    function transferSRRByReveal(
        ...
        bytes32 reveal,
        uint256 tokenId
    ) public override(IStartrailRegistryV6) tokenExists(tokenId) {
