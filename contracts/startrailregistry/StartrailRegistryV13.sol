...
import "../common/IStartrailRegistryV13.sol";
...
contract StartrailRegistryV13 is
    Contracts,
    IStartrailRegistryV13,
    ...
    EIP2771BaseRecipient
{
    ...
    ) public override(IStartrailRegistryV13) trustedForwarderOnly {
        _createSRR(
            isPrimaryIssuer,
            artistAddress,
            metadataDigest,
    ...
    function createSRRFromBulk(
        ...
        bool lockExternalTransfer
    ) public override(IStartrailRegistryV13) returns (uint256) {
        onlyBulk();
        return
            _createSRR(
                isPrimaryIssuer,
    ...
    ) public override(IStartrailRegistryV13) {
        onlyBulk();
    ...
    function transferFromWithProvenanceFromBulk(
        ...
        uint256 customHistoryId,
        bool isIntermediary
    ) external override(IStartrailRegistryV13) {
        onlyBulk();
    ...
    function updateSRRMetadata(uint256 tokenId, bytes32 metadataDigest)
        external
        override(IStartrailRegistryV13)
    {
        onlyLicensedUserOrAdministrator();
        tokenExists(tokenId);
