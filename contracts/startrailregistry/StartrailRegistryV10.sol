...
import "../common/IStartrailRegistryV10.sol";
...
contract StartrailRegistryV10 is
    Contracts,
    IERC2477,
    IStartrailRegistryV10,
    ...
    EIP2771BaseRecipient
{
    ...
    function createSRR(
        ...
        public
        override(IStartrailRegistryV10)
        onlyAdministrator
    {
    ...
    function createSRRFromBulk(
        ...
        bool lockExternalTransfer
    ) public override(IStartrailRegistryV10) onlyBulk returns (uint256) {
        return 
            _createSRR(
                isPrimaryIssuer,
                artistAddress,
    ...
    ) public override(IStartrailRegistryV10) onlyBulk {
    ...
    function transferSRRByReveal(
        ...
        uint256 tokenId,
        bool isIntermediary
    ) public override(IStartrailRegistryV10) tokenExists(tokenId) {
