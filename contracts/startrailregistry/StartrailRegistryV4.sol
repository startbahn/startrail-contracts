...
import "../common/IStartrailRegistryV4.sol";
...
contract StartrailRegistryV4 is
    Contracts,
    IERC2477,
    IStartrailRegistryV4,
    ...
    EIP2771BaseRecipient
{
    ...
    ) public override(IStartrailRegistryV4) onlyBulk returns (uint256) {
        return
            _createSRR(
                isPrimaryIssuer,
                artistAddress,
    ...
    ) public override(IStartrailRegistryV4) onlyBulkTransfer {
    ...
    function transferSRRByReveal(
        ...
        bytes32 reveal,
        uint256 tokenId
    ) public override(IStartrailRegistryV4) tokenExists(tokenId) {
