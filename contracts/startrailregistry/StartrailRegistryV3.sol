...
import "../common/IStartrailRegistryV3.sol";
...
contract StartrailRegistryV3 is
    Contracts,
    IERC2477,
    IStartrailRegistryV3,
    ...
    EIP2771BaseRecipient
{
    ...
    /**
     * @dev Change the maxCombinedHistoryRecords for addHistory
    ...
    ) public override(IStartrailRegistryV3) onlyBulk returns (uint256) {
        return
            _createSRR(
                isPrimaryIssuer,
                artistAddress,
    ...
    ) public override(IStartrailRegistryV3) onlyBulkTransfer {
    ...
    function transferSRRByReveal(
        ...
        bytes32 reveal,
        uint256 tokenId
    ) public override(IStartrailRegistryV3) tokenExists(tokenId) {
        bytes32 commitment;
