...
import "../common/IStartrailRegistryV25.sol";
...
contract StartrailRegistryV25 is
    Contracts,
    IStartrailRegistryV25,
    ...
    IERC2981
{
    ...
    function onlySRROwner(address toCheck, uint256 tokenId) private view {
        require(ownerOf(tokenId) == toCheck, "This is not a SRR owner");
    }
    ...
    ) public override(IStartrailRegistryV25) trustedForwarderOnly {
    ...
    function createSRRFromBulk(
        ...
        address royaltyReceiver,
        uint16 royaltyBasisPoints
    ) public override(IStartrailRegistryV25) returns (uint256) {
        onlyBulk();
        uint256 tokenId = _createSRR(
            isPrimaryIssuer,
            artistAddress,
    ...
    ) public override(IStartrailRegistryV25) {
        onlyBulk();
    ...
    function transferFromWithProvenanceFromBulk(
        ...
        uint256 customHistoryId,
        bool isIntermediary
    ) external override(IStartrailRegistryV25) {
        onlyBulk();
        onlySRROwner(signer, tokenId);
    ...
    function getSRR(
        ...
        public
        view
        override(IStartrailRegistryV25)
        returns (
    ...
    ) public view override(IStartrailRegistryV25) returns (string memory) {
    ...
    function lockExternalTransfer(
        uint256 tokenId
    ) public view override(IStartrailRegistryV25) returns (bool) {
