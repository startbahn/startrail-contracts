...
import "../common/IStartrailRegistryV11.sol";
...
contract StartrailRegistryV11 is
    Contracts,
    IERC2477,
    IStartrailRegistryV11,
    ...
    EIP2771BaseRecipient
{
    ...
    function createSRR(
        ...
        public
        override(IStartrailRegistryV11)
        onlyAdministrator
    {
     ...
     * @param metadataDigest bytes32 of metadata hash
     * @param lockExternalTransfer bool of the flag to disable standard ERC721 transfer methods
     * @param recipient the recipient of the created token
     */
    function createSRR(
        bool isPrimaryIssuer,
        address artistAddress,
        ...
        onlyAdministrator
    {
        uint256 tokenId = _createSRR(isPrimaryIssuer, artistAddress, metadataDigest, msg.sender, lockExternalTransfer);
        ERC721UpgradeSafe._transfer(msg.sender, recipient, tokenId);
    }
        ...
        trustedForwarderOnly
    {
        ...
        ERC721UpgradeSafe._transfer(msgSender(), recipient, tokenId);
    }
    ...
    function createSRRFromBulk(
        ...
        bool lockExternalTransfer
    ) public override(IStartrailRegistryV11) onlyBulk returns (uint256) {
        return 
            _createSRR(
                isPrimaryIssuer,
                artistAddress,
    ...
    ) public override(IStartrailRegistryV11) onlyBulk {
    ...
    function transferSRRByReveal(
        ...
        uint256 tokenId,
        bool isIntermediary
    ) public override(IStartrailRegistryV11) tokenExists(tokenId) {
