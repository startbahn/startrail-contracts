...
import "../common/IStartrailRegistryV8.sol";
...
contract StartrailRegistryV8 is
    Contracts,
    IERC2477,
    ...
    EIP2771BaseRecipient
{
    ...
    function createSRRFromBulk(
        ...
        bool lockExternalTransfer
    ) public override(IStartrailRegistryV8) onlyBulkIssue returns (uint256) {
        return 
            _createSRR(
                isPrimaryIssuer,
                artistAddress,
    ...
    ) public override(IStartrailRegistryV8) onlyBulkTransfer {
    ...
    function transferSRRByReveal(
        ...
        uint256 tokenId,
        bool isIntermediary
    ) public override(IStartrailRegistryV8) tokenExists(tokenId) {
