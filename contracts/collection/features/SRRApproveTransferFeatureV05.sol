...
import "./interfaces/ISRRApproveTransferFeatureV05.sol";
 ...
 */
contract SRRApproveTransferFeatureV05 is ISRRApproveTransferFeatureV05 {
    /**
     * @inheritdoc ISRRApproveTransferFeatureV05
     */
    function approveSRRByCommitment(
        ...
        LibFeatureCommonV03.onlyCollectionOwnerOrSRROwner(sender, tokenId);
    ...
    function transferSRRByReveal(
        ...
        LibTransferWithProvenanceV03.logProvenance(
            tokenId,
            from,
            to,
