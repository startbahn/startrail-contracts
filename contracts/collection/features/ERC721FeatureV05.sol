    ...
    Contracts
{
    ...
    function transferFrom(
        ...
        LibFeatureCommonV03.onlyExternalTransferUnlocked(id);
    ...
    function safeTransferFrom(
        ...
        LibFeatureCommonV03.onlyExternalTransferUnlocked(tokenId);
    ...
    function transferFromWithProvenance(
        ...
        bool isSRROwner = LibFeatureCommonV03.isSRROwner(sender, tokenId);
        ...
        // NOT_AUTHORIZED.
        require(isCollectionOwner || isSRROwner, "NOT_AUTHORIZED");
