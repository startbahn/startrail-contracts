 ...
 *   for a given token.
 */
contract LockExternalTransferFeatureV02 is ILockExternalTransferFeatureV02 {
    /**
    ...
    /**
     * @inheritdoc ILockExternalTransferFeatureV02
     */
    function setLockExternalTransfer(
        ...
        LibFeatureCommonV03.getCollectionOwner();
