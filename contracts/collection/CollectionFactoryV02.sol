...
import "./features/interfaces/IERC721FeatureV05.sol";
import "./features/interfaces/IOwnableFeatureV02.sol";
 ...
 */
contract CollectionFactoryV02 is
    OwnableUpgradeable,
    UUPSUpgradeable,
    ...
    MinimalProxyFactory
{
        ...
        nonReentrant
    {
        ...
        LibEIP2771Or4337.onlyLicensedUser(featureRegistry_);
        ...
        address senderAfterAlias = LibEIP2771Or4337.msgSenderAfterAlias(featureRegistry_);
        IOwnableFeatureV02(collectionAddress).__OwnableFeature_initialize(
            senderAfterAlias
        );

        // Initialize ERC721 properties
        IERC721FeatureV05(collectionAddress).__ERC721Feature_initialize(
            name,
            symbol
        );
