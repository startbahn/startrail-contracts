...
interface IStartrailRegistryV6 {
  /*
   * Events for backward compatibility. We plan to remove it in a future release.
   */
  event CreateSRR(
  ...
  // for backward compatibility, to index events emitted from previous contract versions using latest ABI
  event Provenance(
    uint256 indexed tokenId,
