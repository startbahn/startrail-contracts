...
```solidity
function getSRR(uint256 tokenId) external view returns (struct IStartrailRegistryV19.SRR registryRecord, bytes32 metadataDigest)
```
...
| Name | Type | Description |
|---|---|---|
| registryRecord | IStartrailRegistryV19.SRR | dataset / metadataDigest |
| metadataDigest | bytes32 | undefined |
...
```solidity
event CreateSRR(uint256 indexed tokenId, IStartrailRegistryV19.SRR registryRecord, bytes32 metadataDigest, bool lockExternalTransfer)
```
...
|---|---|---|
| tokenId `indexed` | uint256 | undefined |
| registryRecord  | IStartrailRegistryV19.SRR | undefined |
| metadataDigest  | bytes32 | undefined |
...
```solidity
event RoyaltiesSet(uint256 indexed tokenId, IStartrailRegistryV19.RoyaltyInfo royalty)
```
...
|---|---|---|
| tokenId `indexed` | uint256 | undefined |
| royalty  | IStartrailRegistryV19.RoyaltyInfo | undefined |
...
```solidity
event UpdateSRR(uint256 indexed tokenId, IStartrailRegistryV19.SRR registryRecord)
```
