...
```solidity
function getSRR(uint256 tokenId) external view returns (struct IStartrailRegistryV16.SRR registryRecord, bytes32 metadataDigest)
```
...
| Name | Type | Description |
|---|---|---|
| registryRecord | IStartrailRegistryV16.SRR | dataset / metadataDigest |
| metadataDigest | bytes32 | undefined |
...
```solidity
event CreateSRR(uint256 indexed tokenId, IStartrailRegistryV16.SRR registryRecord, bytes32 metadataDigest)
```
...
|---|---|---|
| tokenId `indexed` | uint256 | undefined |
| registryRecord  | IStartrailRegistryV16.SRR | undefined |
| metadataDigest  | bytes32 | undefined |
...
```solidity
event UpdateSRR(uint256 indexed tokenId, IStartrailRegistryV16.SRR registryRecord)
```
