...
```solidity
function createSRR(bool isPrimaryIssuer, address artistAddress, bytes32 metadataDigest, bool lockExternalTransfer_, address to) external nonpayable
```
...
| Name | Type | Description |
|---|---|---|
| registryRecord | IStartrailRegistryV12.SRR | dataset / metadataDigest |
| metadataDigest | bytes32 | undefined |
